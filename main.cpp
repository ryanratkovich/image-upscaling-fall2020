...
void create_file(vector<vector<int>> m){	// creates output file with 512 x 512 matrix data in current working directory
	ofstream file;
	file.open("Output_image.txt");
...
int main(int argc, char** argv) {
	...
	create_file(nearest_neighbor_matrix);	// creates output file
